  ...
  group('users', () {
    test('get users public profile', () async {
      String? response = await NetworkService.GET(
        api: NetworkService.API_GET_USER_PROFILE('Abdulazim'),
        params: NetworkService.paramToGetUsersProfile('Abdulazim'),
      );
      if (response != null) {
    ...
    test('get user\'s photos]', () async {
      String? response = await NetworkService.GET(
        api: NetworkService.API_GET_USER_S('muhammad', "photos"),
    ...
    test('list a user\'s liked photos]', () async {
      String? response = await NetworkService.GET(
        api: NetworkService.API_GET_USER_S('muhammad', 'likes'),
    ...
    test('list a user\'s collections', () async {
      String? response = await NetworkService.GET(
        api: NetworkService.API_GET_USER_S('muhammad', 'collections'),
    ...
    test('list a user\'s liked photos', () async {
      String? response = await NetworkService.GET(
        api: NetworkService.API_GET_USER_S('muhammad', 'statistics'),
        params: NetworkService.paramToGetUserSStatistics(),
      );
      print("aaaaaaaaaaaaaa"+response.toString());
      if (response != null) {
